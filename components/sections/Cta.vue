            ...
            <div
                ...
                <div class="mx-auto text-center max-w-xl md-max-w-2xl relative space-y-8">
                    <h1 text="3xl/tight sm:4xl/tight md:5xl/tight emerald-950 dark:white" class="font-bold">
                        Ganhe experiência
                        <span
                            class="text-transparent bg-clip-text bg-gradient-to-br from-emerald-6 from-20% via-teal-4 via-30% to-teal-6">atendendo
                            pacientes</span>
                        online
                    </h1>
                    ...
                    <div class="mx-auto max-w-md sm-max-w-xl flex justify-center">
                        <nuxt-link to="#" border="~ transparent hover:emerald7"
                            ...
                            <span relative z10>Comece a atender</span>
                        </nuxt-link>
                    </div>
                </div>
            </div>
